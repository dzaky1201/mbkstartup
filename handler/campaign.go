...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	campaignDetail, errDetail := h.service.GetCampaignByID(input)
	if errDetail != nil {
		response := helper.ApiResponse("Failed to get detail of campaign", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
...
func (h *campaignHandler) CreateCampaign(c *gin.Context) {
	...
	newCampaign, errAddCampaign := h.service.CreateCampaign(input)
	if errAddCampaign != nil {
...
func (h *campaignHandler) UpdateCampaign(c *gin.Context) {
	...
	updatedCampaign, errUpdate := h.service.UpdateCampaign(inputID, inputData)
	if errUpdate != nil {
		response := helper.ApiResponse("Failed to update campaign", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
